...
--
-- Table structure for table `theater_review`
--

DROP TABLE IF EXISTS `theater_review`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `theater_review` (
  ...
  CONSTRAINT `theater_review_ibfk_2` FOREIGN KEY (`Branch_ID`, `Theater_ID`) REFERENCES `theater` (`Branch_ID`, `ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `theater_review`
--
